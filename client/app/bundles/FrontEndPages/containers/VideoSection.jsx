      ...
      <div className="container">
        <div className="row">
          <div className="col-xs-12">
            ...
            <Video
              source="https://www.youtube.com/embed/SYwUfCCMHvk"
              text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ornare hendrerit tempor. Vestibulum porttitor ultricies iaculis. Aenean quis mi sem. Mauris feugiat lobortis feugiat. Nulla eu auctor lorem, id placerat felis. Praesent interdum magna non felis ullamcorper, sit amet feugiat quam egestas. Vivamus non lacinia eros, et tincidunt libero."
              header="Suspendisse sollicitudin diam">
            </Video>
            <Video
              source="https://www.youtube.com/embed/zbQfklsvNtU"
