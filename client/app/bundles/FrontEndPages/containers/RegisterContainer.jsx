  ...
  render() {
    return (
      <form role='form' accept-charset="UTF-8" action='/users' method='post'>
        ...
        <TextField labeltext="Full Name" placeholder="Enter your Full Name" type="text" name="user[:name]"></TextField>
        <TextField labeltext="Email Address" placeholder="Enter your Email Address" type="text" name="user[:email]"></TextField>
        <TextField labeltext="User Name" placeholder="Enter your Desired User Name" type="text" name="user[:username]"></TextField>
