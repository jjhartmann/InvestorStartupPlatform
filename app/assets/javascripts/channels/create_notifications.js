// alert("hello");
App.messages = App.cable.subscriptions.create('CreateNotificationChannel', {
  received: function(data,id) {
    return $('.notification-box ul').find('li[data-notification-id="'+ data.notification.id+'"]').prepend(this.renderMessage(data)), $('.notification-box ul').find('li[data-notification-id="'+ data.notification.id+'"]').addClass(data.notification_li_class);
  },
