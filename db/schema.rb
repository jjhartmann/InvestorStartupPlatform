...
ActiveRecord::Schema.define(version: 20161019050437) do

  create_table "admin_meeting_schedules", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.string   "day"
    t.time     "start_time"
    t.time     "end_time"
    ...
    t.index ["investor_profile_id"], name: "index_admin_meeting_schedules_on_investor_profile_id", using: :btree
    t.index ["user_id"], name: "index_admin_meeting_schedules_on_user_id", using: :btree
  end

  create_table "enterprise_photos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "photo"
    t.integer  "enterprise_id"
    t.datetime "created_at",    default: '2016-10-17 11:44:38', null: false
    t.datetime "updated_at",    default: '2016-10-17 11:44:38', null: false
  ...
  create_table "enterprise_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",      default: '2016-10-17 11:44:37', null: false
    t.datetime "updated_at",      default: '2016-10-17 11:44:37', null: false
  ...
  create_table "investor_profiles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "description",    limit: 65535
    t.datetime "created_at",                   default: '2016-10-17 11:44:35', null: false
    t.datetime "updated_at",                   default: '2016-10-17 11:44:35', null: false
  end
  ...
  create_table "invitations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "user_id"
    t.string   "email"
    t.string   "acceptance_status", default: "requested"
    t.datetime "created_at",                              null: false
    t.datetime "updated_at",                              null: false
    t.index ["enterprise_id"], name: "index_invitations_on_enterprise_id", using: :btree
    t.index ["user_id"], name: "index_invitations_on_user_id", using: :btree
  end

  create_table "meeting_members", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "meeting_id"
    t.integer  "memberable_id"
    t.string   "memberable_type"
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["meeting_id"], name: "index_meeting_members_on_meeting_id", using: :btree
  end

  create_table "meeting_room_members", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "meeting_room_id"
    t.integer  "meetable_id"
    t.string   "meetable_type"
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["meeting_room_id"], name: "index_meeting_room_members_on_meeting_room_id", using: :btree
  end

  create_table "meeting_room_message_documents", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "meeting_room_message_id"
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.string   "document"
    t.boolean  "iv"
    t.boolean  "key"
    t.index ["meeting_room_message_id"], name: "index_meeting_room_message_documents_on_meeting_room_message_id", using: :btree
  end

  create_table "meeting_room_messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "meeting_room_id"
    t.integer  "meeting_member_id"
    t.integer  "message_id"
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.integer  "meeting_room_member_id"
    t.index ["meeting_member_id"], name: "index_meeting_room_messages_on_meeting_member_id", using: :btree
    t.index ["meeting_room_id"], name: "index_meeting_room_messages_on_meeting_room_id", using: :btree
    t.index ["meeting_room_member_id"], name: "index_meeting_room_messages_on_meeting_room_member_id", using: :btree
    t.index ["message_id"], name: "index_meeting_room_messages_on_message_id", using: :btree
  end
  ...
  create_table "meeting_rooms", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["meeting_id"], name: "index_meeting_rooms_on_meeting_id", using: :btree
  end
  ...
  create_table "meetings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "investor_profile_id"
    t.index ["enterprise_id"], name: "index_meetings_on_enterprise_id", using: :btree
    t.index ["investor_profile_id"], name: "index_meetings_on_investor_profile_id", using: :btree
  ...
  create_table "messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "topic_id"
    t.integer  "user_id"
    t.datetime "created_at",                default: '2016-10-17 11:44:39', null: false
    t.datetime "updated_at",                default: '2016-10-17 11:44:39', null: false
  ...
  create_table "notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "meeting_id"
    t.index ["meeting_id"], name: "index_notifications_on_meeting_id", using: :btree
  end
  ...
  create_table "offers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "text"
    t.text     "description",     limit: 65535
    t.bigint   "amount_to_offer"
    t.integer  "user_id"
    t.integer  "proposal_id"
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.index ["proposal_id"], name: "index_offers_on_proposal_id", using: :btree
    t.index ["user_id"], name: "index_offers_on_user_id", using: :btree
  end

  create_table "profile_visitors", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "visitee_id"
    t.integer  "visitor_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["visitee_id"], name: "index_profile_visitors_on_visitee_id", using: :btree
    t.index ["visitor_id"], name: "index_profile_visitors_on_visitor_id", using: :btree
  end
  ...
  create_table "proposals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at",                                         default: '2016-10-17 11:44:38', null: false
    t.string   "document"
    t.binary   "iv",                                   limit: 65535
    t.binary   "key",                                  limit: 65535
  ...
  create_table "questions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                    default: '2016-10-17 11:44:36', null: false
    t.datetime "updated_at",                    default: '2016-10-17 11:44:36', null: false
  ...
  create_table "questions_to_ask_enterprises", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "question"
    t.string   "qtype"
    t.integer  "position"
    t.datetime "created_at", null: false
  ...
  create_table "questions_to_ask_entrepreneurs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "question"
    t.string   "qtype"
    t.integer  "position"
    t.datetime "created_at", null: false
  ...
  create_table "questions_to_ask_investors", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "question"
    t.string   "qtype"
    t.integer  "position"
    t.datetime "created_at", null: false
  ...
  create_table "startup_features", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_profile_id"
    t.text     "announcement",    limit: 65535
    t.datetime "created_at",                    null: false
    t.datetime "updated_at",                    null: false
    t.index ["user_profile_id"], name: "index_startup_features_on_user_profile_id", using: :btree
  end
  ...
  add_foreign_key "admin_meeting_schedules", "investor_profiles"
  add_foreign_key "admin_meeting_schedules", "users"
  add_foreign_key "invitations", "enterprises"
  add_foreign_key "invitations", "users"
  add_foreign_key "meeting_members", "meetings"
  add_foreign_key "meeting_room_members", "meeting_rooms"
  add_foreign_key "meeting_room_message_documents", "meeting_room_messages"
  add_foreign_key "meeting_room_messages", "meeting_members"
  add_foreign_key "meeting_room_messages", "meeting_room_members"
  add_foreign_key "meeting_room_messages", "meeting_rooms"
  add_foreign_key "meeting_room_messages", "messages"
  add_foreign_key "meeting_rooms", "meetings"
  add_foreign_key "meetings", "enterprises"
  add_foreign_key "meetings", "investor_profiles"
  add_foreign_key "meetings", "users"
  add_foreign_key "notifications", "meetings"
  add_foreign_key "offers", "proposals"
  add_foreign_key "offers", "users"
  add_foreign_key "startup_features", "user_profiles"
end
