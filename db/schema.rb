...
ActiveRecord::Schema.define(version: 20160905012440) do

  create_table "enterprise_photos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "photo"
    t.integer  "enterprise_id"
    t.datetime "created_at",    default: '2016-09-05 06:38:17', null: false
    t.datetime "updated_at",    default: '2016-09-05 06:38:17', null: false
  ...
  create_table "enterprise_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",      default: '2016-09-05 06:38:16', null: false
    t.datetime "updated_at",      default: '2016-09-05 06:38:16', null: false
  ...
  create_table "investor_profiles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "description",    limit: 65535
    t.datetime "created_at",                   default: '2016-09-05 06:38:14', null: false
    t.datetime "updated_at",                   default: '2016-09-05 06:38:14', null: false
  end
  ...
  create_table "messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "topic_id"
    t.integer  "user_id"
    t.datetime "created_at",                default: '2016-09-05 06:38:18', null: false
    t.datetime "updated_at",                default: '2016-09-05 06:38:18', null: false
  ...
  create_table "target_followers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "target_id"
    t.string   "target_type"
    t.datetime "created_at",    default: '2016-09-05 06:38:15', null: false
    t.datetime "updated_at",    default: '2016-09-05 06:38:15', null: false
