...
ActiveRecord::Schema.define(version: 20160828040415) do
  ...
  create_table "enterprise_photos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",    default: '2016-09-01 03:28:31', null: false
    t.datetime "updated_at",    default: '2016-09-01 03:28:31', null: false
  ...
  create_table "investor_profiles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text     "description",    limit: 65535
    t.datetime "created_at",                   default: '2016-09-01 03:28:30', null: false
    t.datetime "updated_at",                   default: '2016-09-01 03:28:30', null: false
  end
