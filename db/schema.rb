...
ActiveRecord::Schema.define(version: 20160828040415) do
  ...
  create_table "enterprise_photos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",    default: '2016-09-01 12:51:31', null: false
    t.datetime "updated_at",    default: '2016-09-01 12:51:31', null: false
  ...
  create_table "enterprise_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",      default: '2016-09-01 12:51:28', null: false
    t.datetime "updated_at",      default: '2016-09-01 12:51:28', null: false
  ...
  create_table "enterprises", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                      default: '2016-09-01 12:51:30', null: false
    t.datetime "updated_at",                      default: '2016-09-01 12:51:30', null: false
