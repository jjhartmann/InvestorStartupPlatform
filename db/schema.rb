...
ActiveRecord::Schema.define(version: 20160827031312) do

  create_table "enterprise_photos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "photo"
    t.integer  "enterprise_id"
    t.datetime "created_at",    default: '2016-08-27 03:29:02', null: false
    t.datetime "updated_at",    default: '2016-08-27 03:29:02', null: false
  ...
  create_table "proposal_for_investors", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "user_id"
    t.datetime "created_at",  default: '2016-08-27 03:29:03', null: false
    t.datetime "updated_at",  default: '2016-08-27 03:29:03', null: false
